module.exports = (name, verifyLink, timeToExpire) => {
  return `
                  ...
                  <td style="padding: 40px 0px 0px;">
                    ...
                    <div style="padding: 20px; background-color: rgb(255, 255, 255);">
                      <div style="color: rgb(0, 0, 0); text-align: left;">
                        ...
                        <p style="padding-bottom: 16px">${name}, Follow this link to verify your email address before expires in ${timeToExpire}.</p>
